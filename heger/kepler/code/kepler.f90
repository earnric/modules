...
!.... setup takes care of restarting or generating
  ...
  print*,'[PYTHON] setting up kepler ...'

  call setup(inputarg, nargs)

!.... cycle drives the calculation...it should not return here
...
subroutine pygets(ttymsg)
  ...
  !f2py    intent(callback, hide) getskepler(data)
  external getskepler

  call getskepler(data)
